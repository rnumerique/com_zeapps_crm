...
<div id="total">
    ...
    <div>
        ...
        <span><?php echo number_format(floatval($order->global_discount), 2, ',', ' ') . '%'; ?></span>
    </div>
    <div>
        <strong>Remise (avant taxes)</strong>
        <span><?php $discount_prct = number_format(floatval(floatval($order->global_discount) / 100), 2, ',', ' '); echo ($discount_prct * $total_ht) ? : '0,00'; ?></span>
    </div>
    <div class="separator"></div>
    <div>
