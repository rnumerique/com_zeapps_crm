...
<div id="total">
    <?php if(floatval($quote->global_discount) > 0){ ?>
        ...
        <div>
            ...
            <span><?php echo number_format(floatval($invoice->global_discount), 2, ',', ' ') . '%'; ?></span>
        </div>
        <div>
            <strong>Remise (avant taxes)</strong>
            <span><?php $discount_prct = number_format(floatval(floatval($invoice->global_discount) / 100), 2, ',', ' '); echo ($discount_prct * $total_ht) ? : '0,00'; ?></span>
        </div>
        <div class="separator"></div>
    <?php } ?>
    <div>
