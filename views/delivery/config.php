...
?>
<div id="breadcrumb">Config > livraison</div>
<div id="content">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label i8n="Format de numérotation des livraisons"></label>
            ...
            <div class="col-md-6">
                {{ numerotation }}
                <div class="form-group">
                    <strong i8n="Frequence de remise a 0 de la numérotation des livraisons"></strong>
                    <div class="radio">
                        <label>
