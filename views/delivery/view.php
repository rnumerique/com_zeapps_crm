...
<div id="content">
    ...
    <form>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="pull-right">
                        ...
                        <button type="button" class="btn btn-info btn-xs" ng-click="toggleEdit()" ng-hide="delivery.finalized !== '0'"><i class="fa fa-fw fa-pencil" aria-hidden="true"></i></button>
                        <button type="button" class="btn btn-primary btn-xs" ng-click="print()"><i class="fa fa-fw fa-download" aria-hidden="true"></i></button>
                        <button type="button" class="btn btn-success btn-xs" ng-click="finalize()" ng-hide="delivery.finalized !== '0' || edit">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="well">
                    ...
                    <span ng-hide="edit">{{ delivery.billing_address_1 }}</span><br ng-if="delivery.billing_address_1 && !edit">
                    <input type="text" class="form-control" ng-model="delivery.billing_address_1" ng-show="edit">
                    <span ng-hide="edit">{{ delivery.billing_address_2 }}</span><br ng-if="delivery.billing_address_2 && !edit">
                    <input type="text" class="form-control" ng-model="delivery.billing_address_2" ng-show="edit">
                    <span ng-hide="edit">{{ delivery.billing_address_3 }}</span><br ng-if="delivery.billing_address_3 && !edit">
            ...
            <div class="col-md-6">
                <div class="well">
                    ...
                    {{ company.company_name }}<br ng-if="company.company_name">
                    {{ contact.last_name + ' ' + contact.first_name }}<br ng-if="contact.last_name && contact.first_name">
                    <span ng-hide="edit">{{ delivery.delivery_address_1 }}</span><br ng-if="delivery.delivery_address_1 && !edit">
                    <input type="text" class="form-control" ng-model="delivery.delivery_address_1" ng-show="edit">
                    <span ng-hide="edit">{{ delivery.delivery_address_2 }}</span><br ng-if="delivery.delivery_address_2 && !edit">
                    <input type="text" class="form-control" ng-model="delivery.delivery_address_2" ng-show="edit">
                    <span ng-hide="edit">{{ delivery.delivery_address_3 }}</span><br ng-if="delivery.delivery_address_3 && !edit">
        ...
        <div ng-show="navigationState=='body'">
            <div class="row">
                <div class="col-md-12 text-right"  ng-hide="delivery.finalized !== '0'">
                    ...
                    <table class="table table-striped table-condensed table-responsive">
                        <thead>
                            <tr>
                                ...
                                <th ng-hide="delivery.finalized !== '0'"></th>
                            </tr>
                        </thead>
                        <tbody ui-sortable="sortable" class="sortableContainer" ng-model="lines">
                            <tr ng-repeat="line in lines" ng-class="[line.type == 'subTotal' ? 'sous-total info' : '', line.type == 'comment' ? 'warning' : '']" data-id="{{ line.id }}">
                                ...
                                <td class="text-right" ng-hide="delivery.finalized !== '0'">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                ...
                                <div class="input-group" ng-show="edit">
                                    <input type="text" class="form-control" ng-model="delivery.global_discount" ng-change="updateTotals()">
                                    <div class="input-group-addon">%</div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12" ng-repeat="document in documents">
                    <div>
                        ...
                        <button type="button" class="btn btn-danger btn-xs" ng-click="deleteDocument(document)" ng-hide="delivery.finalized !== '0'">
                            <span class="fa fa-fw fa-trash"></span>
                        </button>
                    </div>
                    <div class="text-muted">
