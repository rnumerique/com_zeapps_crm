...
listModuleModalFunction.push({
	...
	templateUrl:"/com_zeapps_crm/orders/modal_document",
	controller:"ZeAppsCrmModalOrderDocumentCtrl",
	size:"lg",
	resolve:{
		titre: function () {
...
app.controller("ZeAppsCrmModalOrderDocumentCtrl", function($scope, $uibModalInstance, zeHttp, titre, option) {
