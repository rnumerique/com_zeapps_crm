...
listModuleModalFunction.push({
	...
	templateUrl:"/com_zeapps_crm/deliveries/modal_document",
	controller:"ZeAppsCrmModalDeliveryDocumentCtrl",
	size:"lg",
	resolve:{
		titre: function () {
...
app.controller("ZeAppsCrmModalDeliveryDocumentCtrl", function($scope, $uibModalInstance, zeHttp, titre, option) {
