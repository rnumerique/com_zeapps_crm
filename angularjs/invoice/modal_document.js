...
listModuleModalFunction.push({
	...
	templateUrl:"/com_zeapps_crm/invoices/modal_document",
	controller:"ZeAppsCrmModalInvoiceDocumentCtrl",
	size:"lg",
	resolve:{
		titre: function () {
...
app.controller("ZeAppsCrmModalInvoiceDocumentCtrl", function($scope, $uibModalInstance, zeHttp, titre, option) {
